#Raw experiment code, written to serve as a basis for parameterized experiment code
...
while gen < max_runs and not perfect:
    ...
    winner_count = 0
    for i in range(popsize):
        #Scores within 0.01 are allowed for neutral drift
        if best - scores[i] < 0.01:
            winners.append(i)
            winner_count += 1
